...
public class KYNHttpPostRest {
    ...
    public static String postData(String postURI, String data) throws Exception {
        ...
        try {
            if(postURI.toString().startsWith("https")) {
            ...
            httpConn.setRequestProperty(HEADER_TOKEN, KYNIntentConstant.TOKEN);
            httpConn.setRequestProperty(HEADER_USERNAME, KYNIntentConstant.USERNAME);
